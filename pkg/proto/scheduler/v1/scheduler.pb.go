...
func (x *WatchJobsRequestResult) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *WatchJobsResponse) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
var file_dapr_proto_scheduler_v1_scheduler_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x22, 0xa7, 0x01, 0x0a, 0x11, 0x57, 0x61, 0x74,
