...
type SchedulerClient interface {
	...
	// WatchHosts is used by the daprd sidecars to dynamically get the current set of all active Scheduler instances to
	// keep the sidecars updated as Schedulers scale up or down
